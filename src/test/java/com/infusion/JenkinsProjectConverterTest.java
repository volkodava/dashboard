...
public class JenkinsProjectConverterTest {
...
//        assertThat(buildTestResultPackageFile.exists(), is(true));
    ...
    public void testConvertProjectContentToObject() throws IOException {
        File projectJsonFile = TestResourcesContainer.PROJECT_FILE_PATH;
        ...
        JenkinsProject bodyObj = (JenkinsProject) converter.read(JenkinsProject.class, inputMessage);
        verifier.checkJenkinsProject(bodyObj);
    }
    ...
    public void testConvertProjectContentToObjectAndViceVersa() throws IOException {
        ...
        inputMessage.getHeaders().setContentType(new MediaType("application", "json"));
        JenkinsProject body = (JenkinsProject) converter.read(JenkinsProject.class, inputMessage);
